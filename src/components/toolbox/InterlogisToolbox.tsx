...
import { holdingProjects as initialHoldingProjects, inmobiliariaProjects as initialInmobiliariaProjects } from '../../data/interlogis';
...
export const InterlogisToolbox: React.FC = () => {
    ...
    const renderProjectTable = (projects: Project[], isHolding: boolean) => (
        <TableContainer>
            <Table>
                <TableHead>
                    <TableRow>
